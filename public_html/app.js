...
app.factory('kamers', [function () {
        ...
        var k = {
            kamers: [
                {title: 'Saarloos', state: "active", kleur: ' lime darken-3', highkleur: " lime lighten-2", imgurl: "../images/saarloosKamer.png", klasse: "Superior", huidig: "", buttonState: "Toon Meer",
                    prijs: '€90', prijsSupplement: "€55", faciliteiten: ["../images/personIcon2.png", "../images/badIcon.png", "../images/toiletIcon.png", "../images/wifiIcon.png", "../images/etenIcon.png", "../images/ontbijtIcon.png", "../images/parkingIcon.png"], geheim: "../images/wolf.png", id: "wolfCol", imgId: "wolfImg", facId: "wolfFac", buttonId: "wolfButton",
                ...
                {title: 'Bievre', state: "", kleur: ' lime darken-3', highkleur: " lime lighten-2", imgurl: "../images/bievre2.png", klasse: "Superior", huidig: "Ze laten zich zelden zien maar ze zijn er wel, getuige de dammen die ze bouwen. Sinds een 15-tal jaar leven er opnieuw bevers in de Naamse Ardennen .Ooit waren ze hier massaal aanwezig maar zo’n honderd jaar geleden werd de laatste opgegeten of geslacht voor zijn pels. Na een herintroductie in Frankrijk zijn de dieren uitgezworven via het water en naar schatting leven er in de Naamse Ardennen momenteel een dertig tot veertig koppels. “De naam van het dorp Bièvre komt trouwens van ‘bever’  ", buttonState: "Toon Meer",
                    prijs: '€90', prijsSupplement: "€55", faciliteiten: ["../images/personIcon2.png", "../images/badIcon.png", "../images/toiletIcon.png", "../images/wifiIcon.png", "../images/etenIcon.png", "../images/ontbijtIcon.png", "../images/parkingIcon.png"], geheim: "../images/bever.jpg", id: "beverCol", imgId: "beverImg", facId: "beverFac", buttonId: "beverButton",
                ...
                {title: 'Yvette', state: "", kleur: ' lime darken-3', highkleur: " lime lighten-2", imgurl: "../images/yvetteKamer.png", klasse: "Superior", huidig: "", buttonState: "Toon Meer",
                    prijs: '€90', prijsSupplement: "€55", faciliteiten: ["../images/personIcon2.png", "../images/badIcon.png", "../images/toiletIcon.png", "../images/wifiIcon.png", "../images/etenIcon.png", "../images/ontbijtIcon.png", "../images/parkingIcon.png"], geheim: "../images/heks.png", id: "heksCol", imgId: "heksImg", facId: "heksFac", buttonId: "heksButton",
                ...
                {title: 'La Tour', state: "", kleur: ' lime darken-3', highkleur: " lime lighten-2", imgurl: "../images/latourKamer.png", klasse: "Standaard", huidig: "", buttonState: "Toon Meer",
                    prijs: '', prijsSupplement: "€55", faciliteiten: ["../images/personIcon2.png", "../images/badIcon.png", "../images/toiletIcon.png", "../images/wifiIcon.png", "../images/etenIcon.png", "../images/ontbijtIcon.png", "../images/parkingIcon.png"], geheim: "../images/toren.png", id: "torenCol", imgId: "torenImg", facId: "torenFac", buttonId: "torenButton",
...
Het is niet alleen een gezellig stoppunt voor wandelaars maar ook een gezellig vertoeven voor zowel de B&B’ers als de lokale bevolking.\n\
 We bieden een waaier aan van plaatselijke biersoorten en wijnen alsook streekgebonden en seizoensgebonden snacks.Voor ieder wat wils ! \n\
 Bij mooi weer staat het gezellige terras ter beschikking van de wandelaars. B&b’ers kunnen eveneens achteraan van de tuin genieten. "}
            ]
        };
        return c;
    }]);
...
app.controller("KamersController", [
    '$scope', 'kamers', function ($scope, kamers) {
        ...
        $scope.clickButton = function (kamer) {
            if (check === true) {
                $("#" + kamer.id).empty().append(kamer.long);
                $("#" + kamer.facId).hide();
                $("#" + kamer.buttonId).empty().append("Info");
                $("#" + kamer.imgId).attr("src", kamer.geheim);
                check = false;
                return;
            }
            if (check === false) {
                $("#" + kamer.id).empty().append("Prijs voor 2 personen: " + kamer.prijs + "<br>" + "Supplement voor 1 persoon: " + kamer.prijsSupplement);
                $("#" + kamer.facId).show();
                $("#" + kamer.buttonId).empty().append("Ontdek het geheim!");
                $("#" + kamer.imgId).attr("src", kamer.imgurl);
                check = true;
                return;
            }
        };
